<template>
    <div style="max-height: 93vh; overflow:auto;">
        ...
        <br>
        <v-card outlined>
            <v-card-title>Past Searches</v-card-title>
        ...
        methods: {
            query() {
                ...
                axios.get('http://10.0.0.23:3001/api/search',{
                    ...
                    vm.businessList = response.data.businesses;
                }).catch(error => {
                    console.log(error);
                });
            },
